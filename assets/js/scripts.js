...
/*===================================*
	27. carousel-template
	*===================================*/
$(document).ready(function () {
  let slickCarouselTemplate = {
    dots: true,
    infinite: true,
    speed: 300,
    slidesToShow: 4,
  ...
  let allBtnMinus = $(".item-box-style .btn-minus");
  let allBtnPlus = $(".item-box-style .btn-plus");
  allBtnMinus.each(function () {
    $(this).click(() => {
      ...
      if (currentValue - 1 > 0) {
        $(this)
          .parent()
          .find("input")
          .val(parseInt(currentValue) - 1);
      }
      // Tăng giá trị lên 1 và cập nhật lại giá trị vào input
    });
  });
  allBtnPlus.each(function () {
    $(this).click(() => {
      // Lấy giá trị hiện tại của input
      let currentValue = $(this).parent().find("input").val();
      // Tăng giá trị lên 1 và cập nhật lại giá trị vào input
...
//   let document.querySelector(".banner_section")
// }
